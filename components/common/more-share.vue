		...
		<uni-popup ref="popup" type="bottom">
			...
			<view class="flex align-center">
				<block v-for="(item,index) in providerList" :key="index">
					<view class="flex-1 flex flex-column align-center justify-center" @tap="share(item)">
						<view class="iconfont text-white flex align-center justify-center font-lg rounded-circle mt-1" :class="item.icon + ' ' + item.color "
...
<script>
	...
	import uniPopupDialog from "../uni-ui/uni-popup-dialog/uni-popup-dialog.vue"
	import uniPopupMessage from "../uni-ui/uni-popup-message/uni-popup-message.vue"
	export default {
		props: {
			item: Object,
			index: Number,
